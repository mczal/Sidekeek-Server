...
getProfile.prototype.handleRoutes = function(router,connection){
  router.post("/getProfile",function(req,res){
    ...
    if(email==null || email==undefined){
      ...
      var query = "select email,bussiness_category.category_name,company_desc,title,tipe.name as tipe from host tipe on host.id_tipe=tipe.id_tipe join bussiness_category on host.category=bussiness_category.id_cat where email='"+email+"'";
